 ...
 *
 */
public class BiomobyObjectActivityContextualViewFactory implements ContextualViewFactory<BiomobyObjectActivity>{
	...
	public List<ContextualView> getViews(BiomobyObjectActivity activity) {
		return Arrays.asList(new ContextualView[] {new BiomobyObjectActivityContextualView(activity, editManager, fileManager)});
	}
